                    ...
                    <div className="flex items-start justify-between gap-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-xs text-slate-500">{candidate.department} â€¢ Readiness {candidate.readiness}%</div>
                        </div>
                      </div>
                  ...
                  <div key={opp.id} className="flex flex-col sm:flex-row sm:items-center justify-between rounded-2xl border border-slate-200 p-4 gap-3 bg-slate-50/50">
                    <div>
                      ...
                      <div className="text-xs text-slate-500 mt-0.5">
                        {opp.category} â€¢ {opp.workType} â€¢ {opp.stipend} â€¢ Deadline: {opp.deadline}
                      </div>
                      <div className="mt-2 flex flex-wrap gap-1">
                        {opp.skillRequirements.map((sr) => (
                          ...
                          >
                            {sr.skill} {sr.type === 'Required' ? 'â­'.repeat(sr.importance) : ''}
                          </span>
                        ))}
                      </div>
                    </div>
