      ...
      {selectedStudent && (
        <div className="mt-5 rounded-2xl border border-[var(--border)] bg-white p-4">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
            <div><h3 className="text-lg font-semibold text-[var(--charcoal)]">{selectedStudent.name}</h3><p className="text-sm text-[var(--muted)]">{selectedStudent.department} â€¢ {selectedStudent.internshipStatus}</p></div>
