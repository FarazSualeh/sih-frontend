...
import { IndustryFeedback } from '@/lib/types';
import { getStoredFeedback, saveFeedback } from '@/lib/mock-data/industry';

export default function IndustryFeedbackPage() {
  const [feedbackList, setFeedbackList] = useState(() => getStoredFeedback());
