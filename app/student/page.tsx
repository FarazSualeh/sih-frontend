  ...
  return (
    <div className="mb-5 flex items-end justify-between gap-4">
      ...
      {action && (
        <button 
          onClick={onAction}
          className="hidden text-sm font-semibold text-coral transition hover:text-ink sm:block"
        >
      ...
      <div className="mx-auto max-w-[1440px] px-5 py-8 sm:px-8 lg:px-10 lg:py-10">
        ...
        <section className="grid gap-5 xl:grid-cols-[1.35fr_1fr]">
          ...
          <div className="grid grid-cols-3 gap-px overflow-hidden rounded-2xl border border-line bg-line">
            {[
              ["Verified skills", "08", "up 2 this month", "#e9f0e8", "/student/skills"],
              ["Applications", "06", "2 interviews", "#fff0d8", "/student/applications"],
              ["Internship matches", "12", "3 new this week", "#e9f0e8", "/student/opportunities"],
            ].map(([label, value, note, color, route]) => (
              <Link
                key={label}
                href={route}
                className="flex min-h-[178px] flex-col justify-between p-4 sm:p-5 transition hover:brightness-95"
        ...
        <div className="mt-10 grid gap-8 xl:grid-cols-[1.1fr_0.9fr]">
          ...
          <section>
            <SectionHeading
              ...
              onAction={() => router.push("/student/assessments")}
            />
            <div className="rounded-2xl border border-line bg-white p-5 sm:p-7">
              ...
              <div className="mt-5 space-y-3">
                {[
                  ...
                  <Link
                    key={title}
                    href="/student/assessments"
                    className="flex items-center gap-3 rounded-xl bg-[#f8f8f5] p-3 transition hover:bg-[#f1f2ed]"
                  >
                    <span
              ...
              <Link
                href="/student/assessments"
                className="mt-6 flex w-full items-center justify-center gap-2 rounded-xl border border-line py-3 text-sm font-bold transition hover:border-ink hover:bg-[#f8f8f5]"
              >
                View standardized assessments <ArrowRight size={16} />
              </Link>
            </div>
          </section>
        </div>
        ...
        <section className="mt-10">
          <SectionHeading
            ...
            onAction={() => router.push("/student/opportunities")}
          />
            ...
            {opportunities.map((opportunity) => (
              ...
              >
                ...
                <Link
                  ...
                  className="mt-6 flex w-full items-center justify-between border-t border-line pt-4 text-sm font-bold transition group-hover:text-coral"
                >
