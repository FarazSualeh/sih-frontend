...
import { ExtendedCandidatePool, getStoredApplications, saveApplications } from '@/lib/mock-data/industry';
import { Student } from '@/lib/types';

function generateCandidateAppId(candidateId: string): string {
  return `app-${candidateId}-${Date.now()}`;
}
...
export default function CandidateDiscoveryPage() {
  ...
  const handleShortlist = (candidate: Student) => {
    ...
    if (existing) {
      ...
      updated.push({
        id: generateCandidateAppId(candidate.id),
